...
## Training
I trained the model on an RTX A5000 for 25 epochs which was around 25 hours. I used the default values of the parameters.

## Results
Some really incredible results are(Posters are generated by DALL-E 3 to make them look more cool):
...
- You can download the pretrained weights from [this Google Drive link](https://drive.google.com/file/d/1cXywOAwZ9iF2veZBCg2y7CKgcmiFrDJN/view?usp=sharing) or you can just use `gdown`:
```bash
gdown https://drive.google.com/uc?id=1cXywOAwZ9iF2veZBCg2y7CKgcmiFrDJN
```
